...
<body>
    ...
    <div id="popup">
        <div class="popup-content">
            <h2>Support Us!</h2>
            <p>Join our Telegram channel @ajay18live for more updates.</p>
            <button class="join-btn" onclick="window.open('https://t.me/+xdQNNePetGxjYjI1', '_blank')">Join Now</button>
    ...
    <footer>
        &copy; 2025 ajayxfancode Sports. All rights reserved.
    </footer>
</body>
</html>
